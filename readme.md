...
|-------|----------------------|--------------------|
| [1. Initialize Git Repo](#-1-initialize-git-repo) | [12. Create New Branch](#-12-create-new-branch) | [16. Connect Remote Repo](#-16-connect-remote-repo) |
| [2. Check Git Version](#-2-check-git-version) | [13. Switch Branch](#-13-switch-branch) | [17. Push to Remote Repo](#-17-push-to-remote-repo) |
| [3. Configure Git Username](#-3-configure-git-username-only-once) | [14. Create & Switch Branch](#-14-create--switch-branch) | [18. Pull from Remote](#-18-pull-from-remote) |
| [4. Configure Git Email](#-4-configure-git-email-only-once) | [15. Delete Branch](#-15-delete-branch) | [19. Clone a Repository](#-19-clone-a-repository) |
| [5. Check Git Config](#-5-check-git-config) | [20. Rename Branch](#-20-rename-branch) | [26. View Remote URLs](#-26-view-remote-urls) |
| [6. Track Files](#-6-track-files) | [31. Create Pull Request](#-31-create-pull-request) | [30. Archive Repo as ZIP](#-30-archive-repo-as-zip) |
| [7. Commit Changes](#-7-commit-changes) |  | [28. Clean Untracked Files](#-28-clean-untracked-files) |
| [8. Check Commit History](#-8-check-commit-history) |  | [29. See Who Edited File](#-29-see-who-edited-file) |
| [9. Check Status](#-9-check-status) |  | [27. See Last Commit](#-27-see-last-commit) |
