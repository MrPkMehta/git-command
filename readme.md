...
| 3. [Configure Git Username](#3-configure-git-username) | 14. [Create & Switch Branch](#14-create--switch-branch) | 25. [Delete All Stashes](#25-delete-all-stashes) |
| 4. [Configure Git Email](#4-configure-git-email) | 15. [Delete Branch](#15-delete-branch) | 26. [View Remote URLs](#26-view-remote-urls) |
...
| 10. [Remove from Staging](#10-remove-from-staging) | 21. [Remove Cached Files](#21-remove-cached-files) | 32. [Fork a Repository](#32-fork-a-repository) |
